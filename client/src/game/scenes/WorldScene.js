...
export default class WorldScene extends Phaser.Scene {
  constructor() {
    ...
    this.player = null
    this.cursors = null
    this.monsters = null      // Phaser physics group
    this.monsterAIs = []      // MonsterAI 实例数组
    this.npcs = null
    this.doors = null
    this.hudTexts = {}
    this.isPaused = false
    ...
    this.lockedTarget = null   // { monster, ai, word }
    this.inputBuffer = ''
  }
  ...
  _killMonster(idx) {
    ...
    ai.defeat()
    this.tweens.add({
      targets: monster, alpha: 0, scale: 0, y: monster.y - 30,
      duration: 400, ease: 'Back.easeIn', onComplete: () => monster.destroy()
    })
